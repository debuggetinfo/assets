...
function Syrniki:AddTarget(Player)
...
function Syrniki:RemoveTarget(Player)
...
function Syrniki:Update(Player, Data)
    local Objects = Data['Objects']

    local Character = Player.Character
    if not Character or not Character.Parent or Character.Parent ~= workspace then
...
do
    Syrniki:CreateThreads('Renderer', RunService.RenderStepped, function()
        ...
        for Player, Data in Syrniki['Cache'] do
            pcall(function()
                Syrniki:Update(Player, Data)
            end)
        end
    end)
end
